    ...
    where TEnum : Enumeration<TEnum>
{
    ...
    public static bool operator ==(Enumeration<TEnum>? a, Enumeration<TEnum>? b) => (a is null && b is null) || (a is not null && b is not null && a.Equals(b));
    ...
    {
        return obj is not null && (GetType() == obj.GetType() && obj is Enumeration<TEnum> otherValue && otherValue.Id.Equals(Id));
    }
